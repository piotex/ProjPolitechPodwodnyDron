...
Ostroslup::Ostroslup(std::shared_ptr<drawNS::Draw3DAPI>& _api, Wektor<double, 3> dlB, Wektor<double, 3> pol)
{
    typ_figury = 4;
    api = _api;
    dlugosciBokow = dlB;
...
bool Ostroslup::czy_kolizja(InterfejsDron* dron)
{
...
void Ostroslup::get_wyliczonePunkty(Wektor<double, 3>* ret) {
